...
def status_from_engine(node_id):
    ...
    elif reference_figee:
        error = ("PTP moteur : référence FIGÉE — aucun échange de synchronisation "
                 "(ni delta brut ni mean path delay). L'horloge tourne en marche libre.")
    elif not gm:
