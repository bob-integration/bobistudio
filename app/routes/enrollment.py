...
def api_pxe_state():
    ...
    token, ctrl = pxe.armed()
    node = db_get_node_by_enroll_token(token) if token else None
    # Mot de passe root du nœud armé : il n'existe nulle part ailleurs, et l'opérateur en a besoin
    # pour la console iLO si le réseau tombe pendant l'installation. Effacé au désarmement.
