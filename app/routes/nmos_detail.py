...
def api_io_mtl():
    ...
    for c in db_get_containers():
        ...
        # Configuration enregistrée mais PAS appliquée : un moteur ne relit son adressage réseau
        # qu'au déploiement. Sans ce champ, un opérateur qui change une interface la voit
        # confirmée à l'écran et n'a aucun moyen de savoir que le moteur tourne encore sur
        # l'ancienne (cf. docker_driver.derive_config_moteur).
        try:
